...
export default function Workflow() {
    ...
    return (
        <div>
            ...
            <div className="workflow-container" onMouseMove={handleMouseMove}>
                {/* Hero Section */}
                <section className="workflow-hero-section">
                    <WorkflowDiagram/>
                    <motion.p
                        initial={{opacity: 0, y: 30}}
                        animate={{opacity: 1, y: 0}}
                        transition={{duration: 1, delay: 0.3}}
                        className="workflow-hero-subtitle"
                    >
                ...
                <section className="content-section">
                    <FadeInSection>
                        ...
                        <p className="project-section-text">
                            Uptrillion, a subsidiary of PAX Technology, Inc., offers an integrated cloud solution for
                            mobile point of sale (mPOS) applications, catering to businesses across various platforms.
                            Their flagship product, the Hummingbird Payment Solution, enables Android devices to process
                            contactless transactions with major card networks, including Visa, MasterCard, American
                            Express, and Discover, without requiring PINs or signatures.
                            VISA PARTNER. This solution is compatible with Android 10 and above, ensuring a seamless
                            payment experience for businesses on the go.
                        </p>
                    </FadeInSection>
